                    ...
                    <tr class="hover:bg-[#0B1220] transition">
                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex items-center justify-end gap-4">
                                ...
                                <!--
                                    IMPORTANTE:
                                    - Cada fila tiene su propio x-data
                                    - Cada formulario tiene su propio x-ref ÚNICO
                                    - El botón NO es submit, es type="button"
                                    - El submit se hace SOLO al confirmar el modal
                                -->
                                <div x-data>
                                    <form
