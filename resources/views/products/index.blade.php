...
<div class="space-y-10">
    ...
    <!-- =========================================================
         ...
         ========================================================= -->
         <div x-data="{ open: true }" x-show="open" class="bg-red-600 ...">
    <button @click="open = false" class="ml-auto text-white font-bold w-5">Cerrar</button>
                    ...
                    <tr class="hover:bg-[#0B1220] transition">
                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex items-center justify-end gap-4">
                                ...
                                <!-- Eliminar -->
                                <div x-data>
                                    <form x-ref="deleteForm{{ $product->id }}" method="POST"
